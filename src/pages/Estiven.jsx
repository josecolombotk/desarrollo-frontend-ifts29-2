  ...
  <i className="bi bi-arrow-clockwise me-1"></i>Rotar imagen
      ...
      <section className="py-5">
        <div className="container">
          ...
          <div id="moviesCarousel" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
              {[
                { img: shelterMovie, title: "Shelter", desc: "Zach trabaja y cuida de su familia mientras encuentra el amor con Gabe." },
                { img: thamePoMovie, title: "Thame y Po", desc: "Po hace un vínculo con Thame, que planea carrera en solitario en Corea." },
                { img: sense8Movie, title: "Sense 8", desc: "Un grupo en todo el mundo está vinculado mentalmente y debe sobrevivir." },
                { img: magiMovie, title: "Magi", desc: "Alibaba y Aladdin exploran mazmorras en busca de tesoros y poder." },
                { img: heartstopperMovie, title: "Heartstopper", desc: "Historia de amor entre Charlie y Nick, con representación LGBTQ+." },
              ].map((movie, idx) => (
                <div className={`carousel-item ${idx === 0 ? "active" : ""}`} key={idx}>
                  <div className="d-flex align-items-center p-4">
                    <div className="flex-shrink-0 me-4">
                      <img src={movie.img} alt={movie.title} style={{ width: "200px", height: "280px", objectFit: "cover", borderRadius: "15px", boxShadow: "0 8px 20px rgba(0,0,0,0.3)" }} />
                    </div>
      ...
      <section className="py-5 bg-light">
        <div className="container">
          ...
          <div id="musicCarousel" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
              {[
                { img: hallOfFameSong, title: "Hall of Fame", desc: "The Script con William.i.am, sobre perseguir sueños y dejar huella." },
                { img: ghostSong, title: "Ghost", desc: "Justin Bieber, balada emotiva sobre pérdida y nostalgia." },
                { img: theNightsSong, title: "The Nights", desc: "Avicii, himno generacional sobre vivir la vida al máximo." },
                { img: youAreTheReasonSong, title: "You Are The Reason", desc: "Calum Scott, emotiva balada sobre amor y vulnerabilidad." },
              ].map((song, idx) => (
                <div className={`carousel-item ${idx === 0 ? "active" : ""}`} key={idx}>
                  <div className="d-flex align-items-center p-4">
                    <div className="flex-shrink-0 me-4">
                      <img src={song.img} alt={song.title} style={{ width: "200px", height: "280px", objectFit: "cover", borderRadius: "15px", boxShadow: "0 8px 20px rgba(0,0,0,0.3)" }} />
                    </div>
                    <div className="flex-grow-1">
                      <h5>{song.title}</h5>
                      <p>{song.desc}</p>
